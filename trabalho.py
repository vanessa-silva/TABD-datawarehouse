...
#cria tabela dw_stand (informacao sobre pracas)
def dw_stand(cursor):
...
#cria tabela dw_local (informacao sobre o local)
def dw_local(cursor):
...
#cria tabela dw_tempo (informacao temporal dos inicios e fins do servico)
def dw_tempo(cursor):
...
#cria tabela dw_taxi (informacao sobre os taxis)
def dw_taxi(cursor):
...
#cria tabela dw_local (informacao sobre os servicos e ligacao as restantes tabelas)
